...
public class Player : MonoBehaviour { public float velocidadDesplamiento = 5; public float velocidadSalto = 5;
public float distanciaRayo = 1.1f; public bool enElPiso;
public Animator anim;
    ...
    // Método que se ejecuta cuando aparece este objeto en pantalla
    void Start() {
